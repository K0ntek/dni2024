    ...
    return(
        <div className="pt-[50px] bg-[#020202] border-t-[4px] border-[#794e29] m-auto justify-center">
           ...
           <div className=' text-[25px] my-[20px] mx-auto space-y-2 justify-center text-center'>
                ...
                <a href="https://www.facebook.com/ZSTiOBANACH/?locale=pl_PL"><GrFacebookOption className='text-white hover:text-gray-700 transition-all duration-300 mx-[5px]'/></a>
                <a href="https://www.instagram.com/zstio.fm/"><GrInstagram className='text-white hover:text-gray-700 transition-all duration-300 mx-[8px]'/></a>
                <a href="https://www.youtube.com/@zstio_fm"><GrYoutube className='text-white hover:text-gray-700 transition-all duration-300 mx-[8px]'/></a>
                <a href="https://www.tiktok.com/@zstio.fm"><FaTiktok className='text-white hover:text-gray-700 transition-all duration-300 mx-[8px]'/></a>
                </div>
            </div>
