    ...
    return(
        <div id="offer" className="offers bg-[#000003] sm:p-[100px] py-[50px] space-y-5">
            <div className="w-[90%] mx-auto bg-[#080808] p-6 rounded-3xl overflow-hidden">
                <h1 className="text-center text-transparent bg-clip-text bg-gradient-to-r from-[#000000] to-gray-200 text-5xl mb-4 font-inter font-[500] ">Technikum nr 2 im. Stefana Banacha</h1>
             ...
             <div className="w-[90%] mx-auto bg-[#080808] p-6 rounded-3xl overflow-hidden">
                <h1 className="text-center text-transparent bg-clip-text bg-gradient-to-r from-[#000000] to-gray-200 text-5xl mb-4 font-inter font-[500] ">Branżowa szkoła I stopnia</h1>
                <div className=" w-[90%] mx-auto sm:w-[100%] grid md:grid-cols-2 xl:grid-cols-3 gap-[8px]">
