...
const About =()=>{
    ...
    return(
        <>
        <div id="about" className="h-[10px] w-full bg-gradient-to-r from-red-600 to-fuchsia-700"></div>
         <div className="bg-black p-[100px] text-[20px] overflow-hidden h-screen" ref={ref}>
            <h1 className=" text-center text-[40px] text-red-600 mb-[50px]">O SZKOLE</h1>
                            ...
                            <>
                                <div key={i} className="group element hover:bg-gradient-to-r hover:from-fuchsia-600 hover:to-[crimson] rounded-3xl w-[180px]">
                                    <div className="text-center rounded-3xl border-[2px] border-[crimson] h-[220px]">
                                        <div className=" text-[50px] text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-[crimson] group-hover:text-black relative top-[10%]">
                                            {inView ? <CountUp start={0} end={countElement.endVariable} duration={2} delay={.3}/> : 0}
                                        </div>
                                    <div className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-[crimson] text-[25px] group-hover:text-black  relative top-[10%]">
